...
/*   Updated: 2025/07/29 15:36:57 by ihajji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_forks(t_data *data)
{
	...
	while (i < data->number_of_philos)
	{
		...
		data->philos[i].left_fork = left_fork;
		if (i > 0)
			data->philos[i].right_fork = data->philos[i - 1].left_fork;
		i++;
	}
	data->philos[0].right_fork = data->philos[i - 1].left_fork;
	return (i);
}
...
int	init_philos(t_data *data)
{
	...
	while (i < data->number_of_philos)
	{
		data->args[i] = (t_args){data, data->philos + i};
